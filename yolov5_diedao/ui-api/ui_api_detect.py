...
class MainWindow(QTabWidget):
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("检测功能")
        img_detection_title.setFont(font_title)
        mid_img_widget = QWidget()
        mid_img_layout = QHBoxLayout()
        self.left_img = QLabel()
        self.right_img = QLabel()
        self.left_img.setPixmap(QPixmap("images/UI/load.jpg"))
        self.right_img.setPixmap(QPixmap("images/UI/download.jpg"))
        ...
        about_title = QLabel('欢迎使用目标检测系统')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/load.jpg'))
        about_img.setAlignment(Qt.AlignCenter)

        label_super = QLabel()
        label_super.setText("欢迎使用目标检测系统")
